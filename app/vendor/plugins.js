			...
			if (scrollTop > 0 && winWidth > headerDisableStickyHeaderWidth){
				...
				if (headerLayout == 'extended'){
					if (scrollTop > (headerMainHeight-headerMainShrinkedHeight)){
						topHeaderHeight = Math.max(headerExtraHeight+(headerMainHeight-headerMainShrinkedHeight)-scrollTop, 36);
					...
					middleHeaderHeight = Math.max(Math.round(headerMainHeight-scrollTop), 36);
